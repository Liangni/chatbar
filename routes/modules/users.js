...
router.post('/:userId/friendships', authenticated, userController.postFriendships);
router.delete('/:userId/friendships', authenticated, userController.deleteFriendships);
